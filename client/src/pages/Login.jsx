        ...
        <div style={styles.container}>
            <div style={styles.card}>
                <h2 style={styles.title}>
                    Welcome to <span style={{color: '#0052cc'}}>Medi</span><span style={{color: '#ff6f61'}}>Sync</span>
                </h2>
...
const styles = {
    ...
    button: { width: '100%', padding: '12px', backgroundColor: '#0052cc', color: 'white', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer', transition: '0.3s' },
    footerText: { marginTop: '20px', fontSize: '14px', color: '#666' },
    link: { color: '#0052cc', textDecoration: 'none', fontWeight: 'bold' }
};
